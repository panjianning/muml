...
<div class="hidden lg:block dropdown">
	<div tabindex="0" class="btn btn-ghost ">
		...
		<span class="hidden md:inline"> 更改主题 </span>
		<svg
			xmlns="http://www.w3.org/2000/svg"
	...
	<ul
		tabindex="0"
		class="mt-14 overflow-y-auto shadow-2xl top-px dropdown-content h-96 w-56 bg-base-200 text-base-content menu menu-compact">
